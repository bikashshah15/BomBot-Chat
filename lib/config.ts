...
const environmentSchema = z.object({
  ...
  HOSTED_SESSION_HOURLY_LIMIT: numericEnvironmentVariable(z.number().finite().int().positive().default(20)),
  HOSTED_IP_HOURLY_LIMIT: numericEnvironmentVariable(z.number().finite().int().positive().default(60)),
  HOSTED_PROCESS_REQUEST_BUDGET: numericEnvironmentVariable(z.number().finite().int().nonnegative().default(200)),
  HOSTED_MAX_TURNS_PER_CONVERSATION: numericEnvironmentVariable(z.number().finite().int().positive().default(20)),
  MAX_USER_MESSAGE_CHARACTERS: numericEnvironmentVariable(z.number().finite().int().positive().default(2000)),
